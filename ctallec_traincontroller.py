...
################################################################################
    ...
    for p_index in range(num_workers):
        Process(target=slave_routine, args=(p_queue, r_queue, 
            e_queue, p_index, rand_ints[p_index], time_limit, 
            args.logdir, tmp_dir,model_variables_dict, return_events)).start()
