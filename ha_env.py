...
# TODO: changed the size of the screen!!
SCREEN_X = 96 # only changing the image input sizes!!
SCREEN_Y = 96
...
class CarRacingWrapper(CarRacing):
  ...
  def _step(self, action):
    ...
    if self.full_episode:
        # TODO: Changed these here. 
      return obs, reward, False, {}#_process_frame(obs), reward, False, {}
    return obs, reward, done, {} #_process_frame(obs), reward, done, {}
